 ...
 */
public class SemiManualPilot extends ControlSet implements Pilot {
	private final Controller joystick1;
	private final RobotDrive drive;
	private VariadicControl joy1x, joy1y, joy1rot;
	private DriverStationLCD dsl;
	private CriteriaCollection cc;
	private final Stereoscope targetor;
	
	public SemiManualPilot(Controller joystick1, RobotDrive drive) {
	...
	public void update() {
		...
		dsl.println(Line.kUser5, 1, "Target position: " + targetor.getX() + ", " + targetor.getY() + ", " + targetor.getDepth());
