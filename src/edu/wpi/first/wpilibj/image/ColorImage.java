...
public abstract class ColorImage extends Image {
    ...
    public String toString() {
    	byte[] byteImage = new byte[image.getSize()];
    	// I don't trust this to do the right thing
    	image.getBytes(0, byteImage, 0, image.getSize());
    	System.out.println("Byte Image length="+byteImage.length);
    	StringBuffer s = new StringBuffer();
    	for (int i = 0; i < byteImage.length; i++) s.append(Integer.toHexString(byteImage[i]));
    	return s.toString();
    }
}
